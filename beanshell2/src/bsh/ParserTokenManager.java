   ...
   switch (pos)
   {
      case 0:
         ...
         if ((active1 & 0x1000100000000000L) != 0L)
            return 65;
         if ((active0 & 0x3ffffffffffffc00L) != 0L)
         {
            jjmatchedKind = 72;
            return 44;
         }
         return -1;
      case 1:
         if ((active0 & 0x3ffffffeff9ffc00L) != 0L)
         {
            if (jjmatchedPos != 1)
            {
               jjmatchedKind = 72;
         ...
         return -1;
      case 2:
         if ((active0 & 0x3efffecebfdffc00L) != 0L)
         {
            if (jjmatchedPos != 2)
            {
               jjmatchedKind = 72;
         ...
         return -1;
      case 3:
         if ((active0 & 0x2c7ffcae3e5d3c00L) != 0L)
         {
            if (jjmatchedPos != 3)
            {
               jjmatchedKind = 72;
         ...
         if ((active0 & 0x128002408182c000L) != 0L)
            return 44;
         return -1;
      case 4:
         ...
         if ((active0 & 0x286080003c053000L) != 0L)
            return 44;
         return -1;
      case 5:
...
private final int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 46:
         return jjStartNfaWithStates_0(0, 83, 11);
      case 47:
         jjmatchedKind = 108;
      ...
      case 60:
         jjmatchedKind = 87;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x8000040000000L, 0x8L);
      case 61:
         jjmatchedKind = 84;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x20000000L, 0x0L);
      case 62:
         jjmatchedKind = 85;
         return jjMoveStringLiteralDfa1_0(0x0L, 0xa0000100000000L, 0xa0L);
      case 63:
         return jjStopAtPos(0, 91);
      case 64:
         return jjMoveStringLiteralDfa1_0(0x0L, 0x4151405281400000L, 0x151L);
      case 91:
      ...
      case 102:
         return jjMoveStringLiteralDfa1_0(0x100000007c000000L, 0x0L, 0x0L);
      case 103:
...
private final int jjMoveStringLiteralDfa1_0(long active0, long active1, long active2)
{
   ...
   switch(curChar)
   {
      ...
      case 97:
         return jjMoveStringLiteralDfa2_0(active0, 0x1000048004018000L, active1, 0x4000004000000000L, active2, 0L);
      case 98:
      ...
      case 102:
         ...
         break;
      case 103:
         return jjMoveStringLiteralDfa2_0(active0, 0L, active1, 0x200400000L, active2, 0L);
      case 104:
      ...
      case 108:
         return jjMoveStringLiteralDfa2_0(active0, 0x20802000L, active1, 0x10000081000000L, active2, 0x10L);
      case 109:
...
private final int jjMoveStringLiteralDfa2_0(long old0, long active0, long old1, long active1, long old2, long active2)
{
   ...
   switch(curChar)
   {
      ...
      case 101:
         return jjMoveStringLiteralDfa3_0(active0, 0x2000000000001000L, active1, 0x10000000000000L, active2, 0x10L);
      case 102:
      ...
      case 116:
         ...
         return jjMoveStringLiteralDfa3_0(active0, 0x40a082014000L, active1, 0x280000000L, active2, 0L);
      case 117:
...
private final int jjMoveStringLiteralDfa3_0(long old0, long active0, long old1, long active1, long old2, long active2)
{
   ...
   switch(curChar)
   {
      ...
      case 101:
         ...
         return jjMoveStringLiteralDfa4_0(active0, 0x2002000000L, active1, 0x280000000L, active2, 0L);
      case 102:
      ...
      case 114:
         ...
         return jjMoveStringLiteralDfa4_0(active0, 0x2000800000000000L, active1, 0L, active2, 0L);
      case 115:
...
"\167\150\151\154\145", "\146\141\143\164", "\161\165\145\162\171", null, null, null, null, null, null, 
null, null, null, null, null, null, null, "\50", "\51", "\173", "\175", "\133", 
"\135", "\73", "\54", "\56", "\75", "\76", "\100\147\164", "\74", "\100\154\164", 
"\41", "\176", "\77", "\72", "\75\75", "\74\75", "\100\154\164\145\161", "\76\75", 
...
static final long[] jjtoToken = {
   0x7ffffffffffffc01L, 0xfffffffffffff9f4L, 0x1ffL, 
};
